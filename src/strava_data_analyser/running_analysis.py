...
from strava_data_analyser.analyser import segments, split_metrics
from strava_data_analyser.analyser.distances import get_distance_distribution
from strava_data_analyser.analyser.highlights import Highlight
from strava_data_analyser.storage import loader
from strava_data_analyser.view import data_format, plot
from strava_data_analyser.view.plot import plot_distance_distribution
...
highlights_requests = [
    ...
    Highlight('earlier_run', 'start_date_local', ascending_sort_order=True),
...
# pd.DataFrame(highlights, columns=columns)
